...
namespace STYLY.Http
{
    ...
    public static class HttpUtils
    {
        ...
        public static UniTask<HttpResponse> SendAsync(this IHttpRequest request)
        {
            ...
            request.OnSuccess(httpResponse => source.TrySetResult(httpResponse))
            .OnError(httpResponse => source.TrySetResult(httpResponse))
            .OnNetworkError(httpResponse => source.TrySetResult(httpResponse))
            .Send();
            return source.Task;
        }
    }
